...
export default function ContactFooter() {
  ...
  return (
    <footer
      ref={containerRef}
      className="relative h-screen w-full bg-[var(--background)] text-[var(--foreground)] transition-colors duration-500 overflow-hidden flex flex-col items-center justify-center"
    >
      {/* Background Gallery (Reveals on scroll) */}
      <div ref={galleryRef} className="absolute inset-0 z-0 opacity-0 pointer-events-none">
        <div className="absolute top-[5%] left-[5%] w-[25vw] h-[35vh] rounded-2xl overflow-hidden transform -rotate-6 shadow-2xl border border-black/10 dark:border-white/10">
          <img
        ...
        <div className="absolute top-[15%] right-[8%] w-[22vw] h-[40vh] rounded-2xl overflow-hidden transform rotate-3 shadow-2xl border border-black/10 dark:border-white/10">
          <img
        ...
        <div className="absolute bottom-[5%] left-[25%] w-[35vw] h-[30vh] rounded-2xl overflow-hidden transform rotate-2 shadow-2xl border border-black/10 dark:border-white/10">
          <img
        ...
        <div className="absolute bottom-[10%] right-[20%] w-[20vw] h-[25vh] rounded-2xl overflow-hidden transform -rotate-3 shadow-2xl border border-black/10 dark:border-white/10">
          <img
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-center pointer-events-none w-full">
        <div ref={getInRef} className="flex justify-start w-full pl-[10vw]">
          <h1 className="text-[14vw] md:text-[10vw] leading-[0.9] font-black tracking-tighter uppercase text-[var(--foreground)] drop-shadow-2xl">
            GET IN
          </h1>
        </div>
      ...
      <div
        ref={contactRef}
        className="relative z-20 flex flex-col items-center justify-center h-full w-full px-6 text-[var(--foreground)] pt-10"
      >
        <div className="flex flex-col items-center gap-8 md:gap-12 w-full max-w-4xl">
          <div className="w-full flex justify-center border-b border-black/20 dark:border-white/20 pb-6">
            <a
            ...
            >
              <span className="text-2xl md:text-4xl">→</span> {contact.email}
            </a>
          </div>
      ...
      {/* Copyright Bar */}
      <div className="absolute bottom-6 left-0 w-full px-8 md:px-12 flex justify-between items-center text-xs md:text-sm text-gray-600 dark:text-gray-500 z-30">
