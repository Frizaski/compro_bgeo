        ...
        <AnimatePresence>
          {trail.map(item => (
            <motion.div
              ...
              className="absolute select-none whitespace-nowrap text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[var(--primary-green)] to-[var(--primary-blue)]"
